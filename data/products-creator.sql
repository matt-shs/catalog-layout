...
SELECT 37 AS [productorder], 'C-080631' AS [sku], 'CAUTION BLANK - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 38 AS [productorder], 'C-080633' AS [sku], 'CAUTION BLANK - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 39 AS [productorder], 'C-083031' AS [sku], 'CONSTRUCTION AREA - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 40 AS [productorder], 'C-083033' AS [sku], 'CONSTRUCTION AREA - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 41 AS [productorder], 'C-162731' AS [sku], 'EYE PROTECTION REQUIRED - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 42 AS [productorder], 'C-162733' AS [sku], 'EYE PROTECTION REQUIRED - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 43 AS [productorder], 'C-961731' AS [sku], 'HEARING PROTECTION REQUIRED IN THIS AREA - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 44 AS [productorder], 'C-961733' AS [sku], 'HEARING PROTECTION REQUIRED IN THIS AREA - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 45 AS [productorder], 'C-920631' AS [sku], 'WATCH YOUR STEP - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 46 AS [productorder], 'C-920633' AS [sku], 'WATCH YOUR STEP - CAUTION SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Caution Signs' AS [category] UNION ALL 
SELECT 47 AS [productorder], 'N-001331' AS [sku], 'AUTHORIZED PERSONNEL ONLY - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 48 AS [productorder], 'N-001333' AS [sku], 'AUTHORIZED PERSONNEL ONLY - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 49 AS [productorder], 'N-370331' AS [sku], 'HARD HATS AND SAFETY GLASSES REQUIRED BEYOND THIS POINT - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 50 AS [productorder], 'N-370333' AS [sku], 'HARD HATS AND SAFETY GLASSES REQUIRED BEYOND THIS POINT - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 51 AS [productorder], 'N-475131' AS [sku], 'NOTICE BLANK - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 52 AS [productorder], 'N-475133' AS [sku], 'NOTICE BLANK - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 53 AS [productorder], 'N-710531' AS [sku], 'SAFETY GLASSES REQUIRED BEYOND THIS POINT - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Notice Signs' AS [category] UNION ALL 
SELECT 54 AS [productorder], 'N-710533' AS [sku], 'SAFETY GLASSES REQUIRED BEYOND THIS POINT - NOTICE SIGN' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Notice Signs' AS [category] UNION ALL 
...
SELECT 87 AS [productorder], 'G-168131' AS [sku], 'EXIT' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 88 AS [productorder], 'G-168133' AS [sku], 'EXIT' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 89 AS [productorder], 'GL-168131' AS [sku], 'EXIT GLOW' AS [producttitle], '10x14' AS [size], 'GLOW ALUMINUM' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 90 AS [productorder], 'GL-168133' AS [sku], 'EXIT GLOW' AS [producttitle], '10x14' AS [size], 'GLOW PLASTIC' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 91 AS [productorder], 'PWS-100' AS [sku], 'AED RED HEART WITH FLASH - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
...
SELECT 93 AS [productorder], 'PWS-2' AS [sku], 'EYE WASH WITH FOUNTAIN PICTO - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 94 AS [productorder], 'PWS-12' AS [sku], 'FIRE EXTINGUISHER WITH ARROW POINTING DOWN - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 95 AS [productorder], 'PWS-5' AS [sku], 'FIRST AID WITH CROSS - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 96 AS [productorder], 'PWS-70' AS [sku], 'SEVERE WEATHER SHELTER WITH TORNADO AND HOUSE SYMBOLS - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 97 AS [productorder], 'FD-5' AS [sku], 'FIRE EXTINGUISHER (W/EXTINGUISHER PICTO)' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 98 AS [productorder], 'FD-49' AS [sku], 'PEDESTRIAN AISLE PICTO FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 99 AS [productorder], 'FD-46' AS [sku], 'PPE REQUIRED BEYOND THIS POINT WITH THREE WORKER HEADS PICTOS FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 100 AS [productorder], 'FD-9901' AS [sku], 'STOP FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 101 AS [productorder], 'FD-21' AS [sku], 'WARNING FORKLIFT TRAFFIC FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 102 AS [productorder], 'EM-017' AS [sku], 'MAP HOLDER' AS [producttitle], '12.5x18.5' AS [size], 'LEXAN' AS [material], 'Evacuation Map Holder' AS [category] UNION ALL 
SELECT 103 AS [productorder], 'EM-085' AS [sku], 'MAP HOLDER' AS [producttitle], '10x12' AS [size], 'LEXAN' AS [material], 'Evacuation Map Holder' AS [category] UNION ALL 
SELECT 104 AS [productorder], 'RT1-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD SOAR TAG' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 105 AS [productorder], 'RT2-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD SOAR TAG' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 106 AS [productorder], 'RT1-713' AS [sku], 'CAUTION SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 107 AS [productorder], 'RT2-713' AS [sku], 'CAUTION SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 108 AS [productorder], 'RT1-182' AS [sku], 'DANGER BARRICADE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 109 AS [productorder], 'RT2-182' AS [sku], 'DANGER BARRICADE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 110 AS [productorder], 'RT1-176' AS [sku], 'DANGER DO NOT OPERATE DATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 111 AS [productorder], 'RT2-176' AS [sku], 'DANGER DO NOT OPERATE DATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 112 AS [productorder], 'RT1-149' AS [sku], 'DANGER DO NOT OPERATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 113 AS [productorder], 'RT2-149' AS [sku], 'DANGER DO NOT OPERATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 114 AS [productorder], 'RT1-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 115 AS [productorder], 'RT2-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 116 AS [productorder], 'RT1-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 117 AS [productorder], 'RT2-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 118 AS [productorder], 'RT1-714' AS [sku], 'DANGER SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 119 AS [productorder], 'RT2-714' AS [sku], 'DANGER SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 120 AS [productorder], 'RT1-712' AS [sku], 'SCAFFOLD OK SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 121 AS [productorder], 'RT2-712' AS [sku], 'SCAFFOLD OK SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 122 AS [productorder], 'VT-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 123 AS [productorder], 'TB-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 124 AS [productorder], 'LT-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 125 AS [productorder], 'VT-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 126 AS [productorder], 'TB-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 127 AS [productorder], 'LT-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 128 AS [productorder], 'VT-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 129 AS [productorder], 'TB-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 130 AS [productorder], 'LT-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 131 AS [productorder], 'VT-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 132 AS [productorder], 'TB-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 133 AS [productorder], 'LT-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 134 AS [productorder], 'VT-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 135 AS [productorder], 'TB-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 136 AS [productorder], 'LT-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 137 AS [productorder], 'VT-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 138 AS [productorder], 'TB-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 139 AS [productorder], 'LT-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 140 AS [productorder], 'VT-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 141 AS [productorder], 'TB-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 142 AS [productorder], 'LT-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 143 AS [productorder], 'VT-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 144 AS [productorder], 'TB-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 145 AS [productorder], 'LT-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 146 AS [productorder], 'VT-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 147 AS [productorder], 'TB-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 148 AS [productorder], 'LT-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 149 AS [productorder], 'VT-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 150 AS [productorder], 'TB-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 151 AS [productorder], 'LT-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 152 AS [productorder], 'VT-992' AS [sku], 'DO NOT OPERATE TAG LOCK TO BE REMOVED BY PERSON TAG WITH PHOTO' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 153 AS [productorder], 'VT-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 154 AS [productorder], 'TB-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 155 AS [productorder], 'LT-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 156 AS [productorder], 'VT-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 157 AS [productorder], 'TB-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 158 AS [productorder], 'LT-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 159 AS [productorder], 'VT-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 160 AS [productorder], 'TB-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 161 AS [productorder], 'LT-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 162 AS [productorder], 'VT-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 163 AS [productorder], 'TB-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 164 AS [productorder], 'LT-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 165 AS [productorder], 'VT-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 166 AS [productorder], 'TB-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 167 AS [productorder], 'LT-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 168 AS [productorder], 'VT-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 169 AS [productorder], 'TB-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 170 AS [productorder], 'LT-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 171 AS [productorder], 'VT-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 172 AS [productorder], 'TB-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 173 AS [productorder], 'LT-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 174 AS [productorder], 'VT-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 175 AS [productorder], 'TB-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 176 AS [productorder], 'LT-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 177 AS [productorder], 'VT-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 178 AS [productorder], 'TB-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 179 AS [productorder], 'LT-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 180 AS [productorder], 'VT-179' AS [sku], 'BLANK WHITE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 100|PACK' AS [material], 'Blank Tags' AS [category] UNION ALL 
SELECT 181 AS [productorder], 'VT-180' AS [sku], 'BLANK RED TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 100|PACK' AS [material], 'Blank Tags' AS [category] UNION ALL 
SELECT 182 AS [productorder], 'BT4058' AS [sku], 'BARRICADE TAPE - CAUTION' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 183 AS [productorder], 'BT4044' AS [sku], 'BARRICADE TAPE - CAUTION DO NOT ENTER' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 184 AS [productorder], 'BT4057' AS [sku], 'BARRICADE TAPE - DANGER' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 185 AS [productorder], 'BT4064' AS [sku], 'BARRICADE TAPE - DANGER HIGH VOLTAGE AREA' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 186 AS [productorder], 'WBC-03' AS [sku], 'CAUTION WOVEN PLASTIC BARRIER TAPE - 2 INCH' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 187 AS [productorder], 'WBC-04' AS [sku], 'DANGER WOVEN PLASTIC BARRIER TAPE - 2 INCH' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 188 AS [productorder], 'WBC-02RB' AS [sku], 'WOVEN PLASTIC BARRIER TAPE - 2 INCH RED' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 189 AS [productorder], 'WBC-02YB' AS [sku], 'WOVEN PLASTIC BARRIER TAPE - 2 INCH YELLOW' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 190 AS [productorder], 'V57203SR' AS [sku], 'CONSPICUITY REFLECTIVE TAPE' AS [producttitle], '2”x30’' AS [size], 'RED|WHITE' AS [material], 'Conspicuity Tape' AS [category] UNION ALL 
SELECT 191 AS [productorder], 'V5720WH' AS [sku], 'CONSPICUITY REFLECTIVE TAPE' AS [producttitle], '2”x150’' AS [size], 'WHITE' AS [material], 'Conspicuity Tape' AS [category] UNION ALL 
SELECT 192 AS [productorder], 'RST100' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'GREEN' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 193 AS [productorder], 'RST101' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'WHITE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 194 AS [productorder], 'RTS102' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'RED' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 195 AS [productorder], 'RST103' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'BLUE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 196 AS [productorder], 'RTS104' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'YELLOW' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 197 AS [productorder], 'RST105' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'ORANGE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 198 AS [productorder], 'RST106' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'YLW|BLK' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 199 AS [productorder], 'RST107' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'RED|WHT' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 200 AS [productorder], 'RST109' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'ORG|WHT' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 201 AS [productorder], 'RST1010' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'WHT|BLK' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 202 AS [productorder], 'SG3104B' AS [sku], 'SAFE STEP ANTI-SLIP TAPE' AS [producttitle], '4”x60’' AS [size], '' AS [material], 'Anti-Slip Tape' AS [category] UNION ALL 
SELECT 203 AS [productorder], 'MF-02WH' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'WHITE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 204 AS [productorder], 'MF-02RD' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'RED' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 205 AS [productorder], 'MF-02YL' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'YELLOW' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 206 AS [productorder], 'MF-02OR' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'ORANGE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 207 AS [productorder], 'MF-02BL' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'BLUE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 208 AS [productorder], 'MF-02GN' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'GREEN' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 209 AS [productorder], 'PBC-02' AS [sku], 'PENNANT FLAGS' AS [producttitle], '60’' AS [size], 'RED' AS [material], 'Pennant Flags' AS [category] UNION ALL 
SELECT 210 AS [productorder], 'PBC-04' AS [sku], 'PENNANT FLAGS' AS [producttitle], '100’' AS [size], 'MULTI' AS [material], 'Pennant Flags' AS [category] UNION ALL 
SELECT 211 AS [productorder], 'AF-01' AS [sku], 'HEAVY DUTY NYLON' AS [producttitle], '36x36' AS [size], 'NYLON' AS [material], 'Airport Flag' AS [category] UNION ALL 
SELECT 212 AS [productorder], '1457VE410KA' AS [sku], 'MASTER LOCK PORTABLE VALVE AND ELECTRICAL LOCKOUT KIT' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 213 AS [productorder], 'S1010E410KA' AS [sku], 'MASTER LOCK PORTABLE ELECTRICAL LOCKOUT KIT' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 214 AS [productorder], '410RED' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'RED' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 215 AS [productorder], '410YLW' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'YELLOW' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 216 AS [productorder], '410ORG' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'ORANGE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 217 AS [productorder], '410BLU' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLUE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 218 AS [productorder], '410TEAL' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'TEAL' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 219 AS [productorder], '410PRP' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'PURPLE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 220 AS [productorder], '410GRN' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'GREEN' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 221 AS [productorder], '410BLK' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLACK' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 222 AS [productorder], '3RED' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'RED' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 223 AS [productorder], '3BLU' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLUE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 224 AS [productorder], '3GRN' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'GREEN' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 225 AS [productorder], '3WHT' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'WHITE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 226 AS [productorder], '3YLW' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'YELLOW' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 227 AS [productorder], '3BLK' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLACK' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 228 AS [productorder], 'S806' AS [sku], 'MASTER LOCK VALVE LOCKOUT ADJUSTABLE CABLE' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 229 AS [productorder], 'S3821' AS [sku], 'MASTER LOCK LOCKOUT DEVICE MINIATURE CIRCUIT BREAKER 120/240V' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 230 AS [productorder], 'HM-125' AS [sku], '10 HOUR OSHA TRAINED - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 231 AS [productorder], 'HM-126' AS [sku], '30 HOUR OSHA TRAINED - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 232 AS [productorder], 'HM-96' AS [sku], 'CERTIFIED FORKLIFT DRIVER WITH FORKLIFT PICTO - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 233 AS [productorder], 'HM-97' AS [sku], 'FALL PROTECTION TRAINED PICTO - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 234 AS [productorder], 'HM-113' AS [sku], 'LOCKOUT TAG-OUT TRAINED WITH PICTO OF HASP TAG & LOCK - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 235 AS [productorder], 'HMRS-522' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE WHITE' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 236 AS [productorder], 'HMRS-523' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE YLW' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 237 AS [productorder], 'HMRS-524' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE RED' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 238 AS [productorder], 'HMRS-525' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE BLUE' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 239 AS [productorder], 'G4-26314' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 240 AS [productorder], 'G4-26313' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'PLASTIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 241 AS [productorder], 'G4-26311' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'ALUMINUM' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 242 AS [productorder], 'FWS-F2' AS [sku], 'FIRE WALL RATED FOR 2 HOURS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 243 AS [productorder], 'FWS-FS' AS [sku], 'FIRE AND SMOKE BARRIER PROTECT ALL OPENINGS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 244 AS [productorder], 'FWS-F6' AS [sku], 'SMOKE WALL PROTECT ALL PENETRATIONS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 245 AS [productorder], 'PWS-1' AS [sku], 'EXIT - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 246 AS [productorder], 'PWS-12' AS [sku], 'FIRE EXTINGUISHER WITH ARROW POINTING DOWN - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 247 AS [productorder], 'P-0488' AS [sku], 'CAUTION WET FLOOR - PREMIUM FLOOR STAND' AS [producttitle], '25x11' AS [size], 'PLASTIC' AS [material], 'Premium Folding Floor Stands' AS [category] UNION ALL 
SELECT 248 AS [productorder], 'P-0489' AS [sku], 'CAUTION WET FLOOR CUIDADA PISO MOJADO - PREMIUM FLOOR STAND' AS [producttitle], '25x11' AS [size], 'PLASTIC' AS [material], 'Premium Folding Floor Stands' AS [category] UNION ALL 
SELECT 249 AS [productorder], 'BA-3001' AS [sku], 'WIDE LOAD / OVERSIZE LOAD DOUBLE-SIDED BANNER' AS [producttitle], '18x96' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 250 AS [productorder], 'SB-419' AS [sku], 'SAFETY FIRST - REINFORCED WHITE VINYL WITH 4 GROMMET TABS' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 251 AS [productorder], 'SB-451' AS [sku], 'BANNER KEEP OUR PLANT CLEAN PICTO PICK-UP CLEAN-UP ELIMINATE' AS [producttitle], '24X60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 252 AS [productorder], 'SB-348' AS [sku], 'WORK SAFELY TODAY' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 253 AS [productorder], 'SB-351' AS [sku], 'YOU ARE THE KEY TO SAFETY' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 254 AS [productorder], 'R1-1RA16' AS [sku], 'STOP SIGN - REGULATORY TRAFFIC SIGN' AS [producttitle], '24x24' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 255 AS [productorder], 'R1-1RA22' AS [sku], 'STOP SIGN - REGULATORY TRAFFIC SIGN' AS [producttitle], '30x30' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 256 AS [productorder], 'R1-2RA22' AS [sku], 'YIELD - REGULATORY TRAFFIC SIGNS' AS [producttitle], '30x30' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 257 AS [productorder], 'R5-1RA16' AS [sku], 'DO NOT ENTER - REGULATORY TRAFFIC SIGNS' AS [producttitle], '24x24' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 258 AS [productorder], 'R5-1HIA22' AS [sku], 'DO NOT ENTER - REGULATORY TRAFFIC SIGNS' AS [producttitle], '30x30' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 259 AS [productorder], 'R2-1HIA9' AS [sku], 'SPEED LIMIT SIGN' AS [producttitle], '24x18' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 260 AS [productorder], 'W11-2ADG16' AS [sku], 'PEDESTRIAN CROSSING SYMBOL - WARNING TRAFFIC SIGN' AS [producttitle], '24x24' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 261 AS [productorder], 'R-70AL5' AS [sku], 'NO PARKING SIGN- RED ON WHITE WITH BORDER - PARKING CONTROL SIGNS' AS [producttitle], '18x12' AS [size], 'ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 262 AS [productorder], 'R-70RA5' AS [sku], 'NO PARKING SIGN- RED ON WHITE WITH BORDER - PARKING CONTROL SIGNS' AS [producttitle], '18x12' AS [size], 'EGP ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 263 AS [productorder], 'R7-8NRA5' AS [sku], 'RESERVED PARKING PICTO - HANDICAPPED PARKING SIGN' AS [producttitle], '18x12' AS [size], 'EGP ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 264 AS [productorder], 'W-65HIA32' AS [sku], 'ROAD WORK AHEAD - CONSTRUCTION TRAFFIC SIGN' AS [producttitle], '48x48' AS [size], 'HIP ALUMINUM' AS [material], 'Road Construction Signs' AS [category] UNION ALL 
SELECT 265 AS [productorder], 'W3-4HIA27' AS [sku], 'BE PREPARED TO STOP - CONSTRUCTION TRAFFIC SIGN' AS [producttitle], '36x36' AS [size], 'HIP ALUMINUM' AS [material], 'Road Construction Signs' AS [category] UNION ALL 
SELECT 266 AS [productorder], 'SMV-1' AS [sku], 'SLOW MOVING VEHICLE SIGN' AS [producttitle], '14x16' AS [size], 'ALUMINUM' AS [material], 'Slow Moving Vehicle Emblems' AS [category] UNION ALL 
SELECT 267 AS [productorder], 'SMV-2' AS [sku], 'SLOW MOVING VEHICLE SIGN' AS [producttitle], '14x16' AS [size], 'REF ALUMINUM' AS [material], 'Slow Moving Vehicle Emblems' AS [category] UNION ALL 
SELECT 268 AS [productorder], 'PL-17R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '18x18' AS [size], 'EGP 12" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 269 AS [productorder], 'PL-18R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '18x18' AS [size], 'EGP 72" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 270 AS [productorder], 'PL-25R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '24x24' AS [size], 'EGP 81" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 271 AS [productorder], 'MS-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 272 AS [productorder], 'MSV-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 273 AS [productorder], 'MSR-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 274 AS [productorder], 'MS-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 275 AS [productorder], 'MSV-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 276 AS [productorder], 'MSR-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 277 AS [productorder], 'MS-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 278 AS [productorder], 'MSV-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 279 AS [productorder], 'MSR-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 280 AS [productorder], 'DL-1000W' AS [sku], 'TRAFFIC SIGN STAND - ROLL UP' AS [producttitle], '36x36' AS [size], 'ALUMINUM | STEEL' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 281 AS [productorder], 'P-8' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '8’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 282 AS [productorder], 'P-10' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '10’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 283 AS [productorder], 'P-12' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '12’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 284 AS [productorder], 'GP-8' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '8’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 285 AS [productorder], 'GP-10' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '10’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 286 AS [productorder], 'GP-12' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '12’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 287 AS [productorder], 'ST-5' AS [sku], 'PORTABLE SIGN BASE AND POST' AS [producttitle], '48x18' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 288 AS [productorder], 'CONE-18' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '18”' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 289 AS [productorder], 'CONE-28' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '28”' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 290 AS [productorder], 'CONE-36' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '36"' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 291 AS [productorder], 'REFCONE-18' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '18”' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 292 AS [productorder], 'REFCONE-28' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '28”' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 293 AS [productorder], 'REFCONE-36' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '36"' AS [size], '' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 294 AS [productorder], 'DOT-05494' AS [sku], 'EXPLOSIVES 1.1 - CLASS 1 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 295 AS [productorder], 'DOT-05499' AS [sku], 'EXPLOSIVES 1.1 - CLASS 1 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 296 AS [productorder], 'DOT-26224' AS [sku], 'NON-FLAMMABLE GAS PICTO BLANK - CLASS 2 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 297 AS [productorder], 'DOT-26229' AS [sku], 'NON-FLAMMABLE GAS PICTO BLANK - CLASS 2 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 298 AS [productorder], 'DOT-26804' AS [sku], 'DOT (FLAME PICTO) FLAMMABLE 3' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 299 AS [productorder], 'DOT-26809' AS [sku], 'DOT (FLAME PICTO) FLAMMABLE 3' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 300 AS [productorder], 'DOT-20874' AS [sku], 'SPONTANEOUSLY COMBUSTIBLE FIRE PICTO - CLASS 4 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 301 AS [productorder], 'DOT-20879' AS [sku], 'SPONTANEOUSLY COMBUSTIBLE FIRE PICTO - CLASS 4 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 302 AS [productorder], 'DOT-57244' AS [sku], 'OXIDIZER - CLASS 5 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 303 AS [productorder], 'DOT-57249' AS [sku], 'OXIDIZER - CLASS 5 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 304 AS [productorder], 'DOT-18444' AS [sku], 'POISON PICTO DIAMOND BLANK - CLASS 6 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 305 AS [productorder], 'DOT-18449' AS [sku], 'POISON PICTO DIAMOND BLANK - CLASS 6 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 306 AS [productorder], 'DOT-77774' AS [sku], 'RADIOACTIVE WITH RAD SYMBOL - CLASS 7 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 307 AS [productorder], 'DOT-77779' AS [sku], 'RADIOACTIVE WITH RAD SYMBOL - CLASS 7 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 308 AS [productorder], 'DOT-08374' AS [sku], '(PICTO) CORROSIVE CLASS 8' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 309 AS [productorder], 'DOT-08379' AS [sku], '(PICTO) CORROSIVE CLASS 8' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 310 AS [productorder], 'DOT-11084' AS [sku], 'DANGEROUS RED TRIANGLE - CLASS 9 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 311 AS [productorder], 'DOT-11089' AS [sku], 'DANGEROUS RED TRIANGLE - CLASS 9 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 312 AS [productorder], 'DOT-96754' AS [sku], 'DOT (FLAME PICTO) 1993 FLAMMABLE LIQUIDS n.o.s. FUEL OIL DIESEL FUEL CLASS 3 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 313 AS [productorder], 'DOT-96759' AS [sku], 'DOT (FLAME PICTO) 1993 FLAMMABLE LIQUIDS n.o.s. FUEL OIL DIESEL FUEL CLASS 3 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards' AS [category] UNION ALL 
SELECT 314 AS [productorder], 'PLT-02' AS [sku], '4 LEGEND PLACARD SYSTEM WITH METAL FLIP UN NUMBERS' AS [producttitle], '14X14' AS [size], 'ALUMINUM' AS [material], 'DOT Flip Placards and Holders' AS [category] UNION ALL 
SELECT 315 AS [productorder], 'PLT-03' AS [sku], '6 LEGEND PLACARD SYSTEM WITH METAL FLIP UN NUMBERS' AS [producttitle], '14X14' AS [size], 'ALUMINUM' AS [material], 'DOT Flip Placards and Holders' AS [category] UNION ALL 
SELECT 316 AS [productorder], 'PLT-01' AS [sku], 'RIVETED ALUMINUM PLACARD HOLDER' AS [producttitle], '12x14' AS [size], 'ALUMINUM' AS [material], 'DOT Flip Placards and Holders' AS [category]
...
SELECT 87 AS [productorder], 'G-168131' AS [sku], 'EXIT' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 88 AS [productorder], 'G-168133' AS [sku], 'EXIT' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 89 AS [productorder], 'GL-168131' AS [sku], 'EXIT GLOW' AS [producttitle], '10x14' AS [size], 'ALUMINUM' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 90 AS [productorder], 'GL-168133' AS [sku], 'EXIT GLOW' AS [producttitle], '10x14' AS [size], 'PLASTIC' AS [material], 'Exit Signs' AS [category] UNION ALL 
SELECT 91 AS [productorder], 'PWS-100' AS [sku], 'AED RED HEART WITH FLASH - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 92 AS [productorder], 'PWS-2' AS [sku], 'EYE WASH WITH FOUNTAIN PICTO - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 93 AS [productorder], 'PWS-12' AS [sku], 'FIRE EXTINGUISHER WITH ARROW POINTING DOWN - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 94 AS [productorder], 'PWS-5' AS [sku], 'FIRST AID WITH CROSS - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 95 AS [productorder], 'PWS-12' AS [sku], 'FIRE EXTINGUISHER WITH ARROW POINTING DOWN - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 96 AS [productorder], 'PWS-1' AS [sku], 'EXIT - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 97 AS [productorder], 'PWS-70' AS [sku], 'SEVERE WEATHER SHELTER WITH TORNADO AND HOUSE SYMBOLS - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Projecting Wall Signs' AS [category] UNION ALL 
SELECT 98 AS [productorder], 'FD-5' AS [sku], 'FIRE EXTINGUISHER (W/EXTINGUISHER PICTO)' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 99 AS [productorder], 'FD-49' AS [sku], 'PEDESTRIAN AISLE PICTO FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 100 AS [productorder], 'FD-46' AS [sku], 'PPE REQUIRED BEYOND THIS POINT WITH THREE WORKER HEADS PICTOS FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 101 AS [productorder], 'FD-21' AS [sku], 'WARNING FORKLIFT TRAFFIC FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 102 AS [productorder], 'FD-9901' AS [sku], 'STOP FLOOR DECAL' AS [producttitle], '17x17' AS [size], 'NON-SLIP' AS [material], 'Floor Decals' AS [category] UNION ALL 
SELECT 103 AS [productorder], 'EM-017' AS [sku], 'MAP HOLDER' AS [producttitle], '12.5x18.5' AS [size], 'LEXAN' AS [material], 'Evacuation Map Holder' AS [category] UNION ALL 
SELECT 104 AS [productorder], 'EM-085' AS [sku], 'MAP HOLDER' AS [producttitle], '10x12' AS [size], 'LEXAN' AS [material], 'Evacuation Map Holder' AS [category] UNION ALL 
SELECT 105 AS [productorder], 'RT1-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD SOAR TAG' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 106 AS [productorder], 'RT2-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD SOAR TAG' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 107 AS [productorder], 'RT1-713' AS [sku], 'CAUTION SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 108 AS [productorder], 'RT2-713' AS [sku], 'CAUTION SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 109 AS [productorder], 'RT1-182' AS [sku], 'DANGER BARRICADE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 110 AS [productorder], 'RT2-182' AS [sku], 'DANGER BARRICADE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 111 AS [productorder], 'RT1-176' AS [sku], 'DANGER DO NOT OPERATE DATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 112 AS [productorder], 'RT2-176' AS [sku], 'DANGER DO NOT OPERATE DATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 113 AS [productorder], 'RT1-149' AS [sku], 'DANGER DO NOT OPERATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 114 AS [productorder], 'RT2-149' AS [sku], 'DANGER DO NOT OPERATE SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 115 AS [productorder], 'RT1-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 116 AS [productorder], 'RT2-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 117 AS [productorder], 'RT1-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 118 AS [productorder], 'RT2-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 119 AS [productorder], 'RT1-714' AS [sku], 'DANGER SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 120 AS [productorder], 'RT2-714' AS [sku], 'DANGER SCAFFOLD SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 121 AS [productorder], 'RT1-712' AS [sku], 'SCAFFOLD OK SOAR TAGS' AS [producttitle], '6x3' AS [size], '100|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 122 AS [productorder], 'RT2-712' AS [sku], 'SCAFFOLD OK SOAR TAGS' AS [producttitle], '6x3' AS [size], '250|ROLL' AS [material], 'Safety On A Roll Tags' AS [category] UNION ALL 
SELECT 123 AS [productorder], 'VT-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 124 AS [productorder], 'TB-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 125 AS [productorder], 'LT-182' AS [sku], 'DANGER BARRICADE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 126 AS [productorder], 'VT-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 127 AS [productorder], 'TB-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 128 AS [productorder], 'LT-101-2' AS [sku], 'DANGER BLANK TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 129 AS [productorder], 'VT-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 130 AS [productorder], 'TB-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 131 AS [productorder], 'LT-108-1' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 1' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 132 AS [productorder], 'VT-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 133 AS [productorder], 'TB-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 134 AS [productorder], 'LT-108-2' AS [sku], 'DANGER DO NOT OPERATE TAGS - BACK 2' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 135 AS [productorder], 'VT-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 136 AS [productorder], 'TB-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 137 AS [productorder], 'LT-312' AS [sku], 'CAUTION BARRICADE TAG POTENTIAL HAZARD TAG' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Accident Prevention Tags' AS [category] UNION ALL 
SELECT 138 AS [productorder], 'VT-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 139 AS [productorder], 'TB-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 140 AS [productorder], 'LT-1004' AS [sku], 'DANGER DO NOT OPERATE - THIS TAG AND LOCK TO BE REMOVED TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 141 AS [productorder], 'VT-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 142 AS [productorder], 'TB-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 143 AS [productorder], 'LT-176' AS [sku], 'DANGER DO NOT OPERATE DATE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 144 AS [productorder], 'VT-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 145 AS [productorder], 'TB-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 146 AS [productorder], 'LT-149' AS [sku], 'DANGER DO NOT OPERATE TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 147 AS [productorder], 'VT-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 148 AS [productorder], 'TB-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 149 AS [productorder], 'LT-177' AS [sku], 'DANGER DO NOT OPERATE THIS ENERGY SOURCE HAS BEEN LOCKED OUT TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 150 AS [productorder], 'VT-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 151 AS [productorder], 'TB-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 152 AS [productorder], 'LT-147' AS [sku], 'DANGER EQUIPMENT LOCKED BY TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 153 AS [productorder], 'VT-992' AS [sku], 'DO NOT OPERATE TAG LOCK TO BE REMOVED BY PERSON TAG WITH PHOTO' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 10|PACK' AS [material], 'Lockout Tags' AS [category] UNION ALL 
SELECT 154 AS [productorder], 'VT-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 155 AS [productorder], 'TB-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 156 AS [productorder], 'LT-1005' AS [sku], 'DANGER THIS TAG & LOCK TO BE REMOVED ONLY BY THE PERSON TAG' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Bilingual Tags' AS [category] UNION ALL 
SELECT 157 AS [productorder], 'VT-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 158 AS [productorder], 'TB-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 159 AS [productorder], 'LT-201' AS [sku], 'EMERGENCY SHOWER & EYE WASH TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 160 AS [productorder], 'VT-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 161 AS [productorder], 'TB-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 162 AS [productorder], 'LT-206' AS [sku], 'FIRE EXTINGUISHER RECHARGE AND INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 163 AS [productorder], 'VT-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 164 AS [productorder], 'TB-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 165 AS [productorder], 'LT-205' AS [sku], 'FIRE EXTINGUISHER TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 166 AS [productorder], 'VT-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 167 AS [productorder], 'TB-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 168 AS [productorder], 'LT-423' AS [sku], 'LADDER INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 169 AS [productorder], 'VT-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 170 AS [productorder], 'TB-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 171 AS [productorder], 'LT-422' AS [sku], 'SCAFFOLD INSPECTION TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Inspection Tags' AS [category] UNION ALL 
SELECT 172 AS [productorder], 'VT-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 173 AS [productorder], 'TB-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 174 AS [productorder], 'LT-712' AS [sku], 'SCAFFOLD OK TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 175 AS [productorder], 'VT-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 176 AS [productorder], 'TB-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 177 AS [productorder], 'LT-713' AS [sku], 'CAUTION SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 178 AS [productorder], 'VT-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 179 AS [productorder], 'TB-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'TAGBOARD 25|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 180 AS [productorder], 'LT-714' AS [sku], 'DANGER SCAFFOLD TAGS' AS [producttitle], '6x3' AS [size], 'LAMINATED 10|PACK' AS [material], 'Scaffold Tags' AS [category] UNION ALL 
SELECT 181 AS [productorder], 'VT-179' AS [sku], 'BLANK WHITE TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 100|PACK' AS [material], 'Blank Tags' AS [category] UNION ALL 
SELECT 182 AS [productorder], 'VT-180' AS [sku], 'BLANK RED TAGS' AS [producttitle], '6x3' AS [size], 'RIGID VINYL 100|PACK' AS [material], 'Blank Tags' AS [category] UNION ALL 
SELECT 183 AS [productorder], 'BT4058' AS [sku], 'BARRICADE TAPE - CAUTION' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 184 AS [productorder], 'BT4044' AS [sku], 'BARRICADE TAPE - CAUTION DO NOT ENTER' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 185 AS [productorder], 'BT4057' AS [sku], 'BARRICADE TAPE - DANGER' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 186 AS [productorder], 'BT4064' AS [sku], 'BARRICADE TAPE - DANGER HIGH VOLTAGE AREA' AS [producttitle], '3”x1000’' AS [size], '' AS [material], 'Barricade Tape' AS [category] UNION ALL 
SELECT 187 AS [productorder], 'WBC-03' AS [sku], 'CAUTION WOVEN PLASTIC BARRIER TAPE - 2 INCH' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 188 AS [productorder], 'WBC-04' AS [sku], 'DANGER WOVEN PLASTIC BARRIER TAPE - 2 INCH' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 189 AS [productorder], 'WBC-02RB' AS [sku], 'WOVEN PLASTIC BARRIER TAPE - 2 INCH RED' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 190 AS [productorder], 'WBC-02YB' AS [sku], 'WOVEN PLASTIC BARRIER TAPE - 2 INCH YELLOW' AS [producttitle], '2”x200’' AS [size], 'PLASTIC' AS [material], 'Woven Plastic Barrier Tape' AS [category] UNION ALL 
SELECT 191 AS [productorder], 'V57203SR' AS [sku], 'CONSPICUITY REFLECTIVE TAPE' AS [producttitle], '2”x30’' AS [size], 'RED|WHITE' AS [material], 'Conspicuity Tape' AS [category] UNION ALL 
SELECT 192 AS [productorder], 'V5720WH' AS [sku], 'CONSPICUITY REFLECTIVE TAPE' AS [producttitle], '2”x150’' AS [size], 'WHITE' AS [material], 'Conspicuity Tape' AS [category] UNION ALL 
SELECT 193 AS [productorder], 'RST100' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'GREEN' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 194 AS [productorder], 'RST101' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'WHITE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 195 AS [productorder], 'RTS102' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'RED' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 196 AS [productorder], 'RST103' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'BLUE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 197 AS [productorder], 'RTS104' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'YELLOW' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 198 AS [productorder], 'RST105' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'ORANGE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 199 AS [productorder], 'RST106' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'YELLOW|BLACK' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 200 AS [productorder], 'RST107' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'RED|WHITE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 201 AS [productorder], 'RST109' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'ORANGE|WHITE' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 202 AS [productorder], 'RST1010' AS [sku], 'REFLECTIVE SAFETY TAPE - 2 Inch' AS [producttitle], '2”x30’' AS [size], 'WHITE|BLACK' AS [material], 'Reflective Tape' AS [category] UNION ALL 
SELECT 203 AS [productorder], 'SG3104B' AS [sku], 'SAFE STEP ANTI-SLIP TAPE' AS [producttitle], '4”x60’' AS [size], '' AS [material], 'Anti-Skid Tape' AS [category] UNION ALL 
SELECT 204 AS [productorder], 'MF-02WH' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'WHITE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 205 AS [productorder], 'MF-02RD' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'RED' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 206 AS [productorder], 'MF-02YL' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'YELLOW' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 207 AS [productorder], 'MF-02OR' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'ORANGE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 208 AS [productorder], 'MF-02BL' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'BLUE' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 209 AS [productorder], 'MF-02GN' AS [sku], 'MARKING FLAGS' AS [producttitle], '2.5x3.5x30' AS [size], 'GREEN' AS [material], 'Marking Flags' AS [category] UNION ALL 
SELECT 210 AS [productorder], 'PBC-02' AS [sku], 'PENNANT FLAGS' AS [producttitle], '60’' AS [size], 'RED' AS [material], 'Pennant Flags' AS [category] UNION ALL 
SELECT 211 AS [productorder], 'PBC-04' AS [sku], 'PENNANT FLAGS' AS [producttitle], '100’' AS [size], 'MULTI' AS [material], 'Pennant Flags' AS [category] UNION ALL 
SELECT 212 AS [productorder], 'AF-01' AS [sku], 'HEAVY DUTY NYLON' AS [producttitle], '36x36' AS [size], 'NYLON' AS [material], 'Airport Flag' AS [category] UNION ALL 
SELECT 213 AS [productorder], '1457VE410KA' AS [sku], 'MASTER LOCK PORTABLE VALVE AND ELECTRICAL LOCKOUT KIT' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 214 AS [productorder], 'S1010E410KA' AS [sku], 'MASTER LOCK PORTABLE ELECTRICAL LOCKOUT KIT' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 215 AS [productorder], '410RED' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'RED' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 216 AS [productorder], '410YLW' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'YELLOW' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 217 AS [productorder], '410ORG' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'ORANGE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 218 AS [productorder], '410BLU' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLUE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 219 AS [productorder], '410TEAL' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'TEAL' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 220 AS [productorder], '410PRP' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'PURPLE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 221 AS [productorder], '410GRN' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'GREEN' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 222 AS [productorder], '410BLK' AS [sku], 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLACK' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 223 AS [productorder], '3RED' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'RED' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 224 AS [productorder], '3BLU' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLUE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 225 AS [productorder], '3GRN' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'GREEN' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 226 AS [productorder], '3WHT' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'WHITE' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 227 AS [productorder], '3YLW' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'YELLOW' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 228 AS [productorder], '3BLK' AS [sku], 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' AS [producttitle], '' AS [size], 'BLACK' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 229 AS [productorder], 'S806' AS [sku], 'MASTER LOCK VALVE LOCKOUT ADJUSTABLE CABLE' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 230 AS [productorder], 'S3821' AS [sku], 'MASTER LOCK LOCKOUT DEVICE MINIATURE CIRCUIT BREAKER 120/240V' AS [producttitle], '' AS [size], '' AS [material], 'Master Lock™' AS [category] UNION ALL 
SELECT 231 AS [productorder], 'HM-125' AS [sku], '10 HOUR OSHA TRAINED - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 232 AS [productorder], 'HM-126' AS [sku], '30 HOUR OSHA TRAINED - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 233 AS [productorder], 'HM-96' AS [sku], 'CERTIFIED FORKLIFT DRIVER WITH FORKLIFT PICTO - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 234 AS [productorder], 'HM-97' AS [sku], 'FALL PROTECTION TRAINED PICTO - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 235 AS [productorder], 'HM-113' AS [sku], 'LOCKOUT TAG-OUT TRAINED WITH PICTO OF HASP TAG & LOCK - HELMET / HARD HAT MARKERS' AS [producttitle], '2x2' AS [size], 'ADHESIVE VINYL 25|PACK' AS [material], 'Hard Hat and Helmet Markers' AS [category] UNION ALL 
SELECT 236 AS [productorder], 'HMRS-522' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE WHITE' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 237 AS [productorder], 'HMRS-523' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE YLW' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 238 AS [productorder], 'HMRS-524' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE RED' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 239 AS [productorder], 'HMRS-525' AS [sku], 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' AS [producttitle], '1x4' AS [size], 'REFLECTIVE BLUE' AS [material], 'Reflective Hard Hat Strips' AS [category] UNION ALL 
SELECT 240 AS [productorder], 'G4-26314' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 241 AS [productorder], 'G4-26313' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'PLASTIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 242 AS [productorder], 'G4-26311' AS [sku], 'FIRE EXTINGUISHER RED ON WHT DOWN ARROW' AS [producttitle], '20x4' AS [size], 'ALUMINUM' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 243 AS [productorder], 'FWS-F2' AS [sku], 'FIRE WALL RATED FOR 2 HOURS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 244 AS [productorder], 'FWS-FS' AS [sku], 'FIRE AND SMOKE BARRIER PROTECT ALL OPENINGS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 245 AS [productorder], 'FWS-F6' AS [sku], 'SMOKE WALL PROTECT ALL PENETRATIONS' AS [producttitle], '4x12' AS [size], 'ADHESIVE VINYL' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 246 AS [productorder], 'PWS-12' AS [sku], 'FIRE EXTINGUISHER WITH ARROW POINTING DOWN - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 247 AS [productorder], 'PWS-1' AS [sku], 'EXIT - PROJECTING WALL SIGN' AS [producttitle], '6x12' AS [size], 'ACRYLIC' AS [material], 'Fire Protection Signs' AS [category] UNION ALL 
SELECT 248 AS [productorder], 'P-0488' AS [sku], 'CAUTION WET FLOOR - PREMIUM FLOOR STAND' AS [producttitle], '25x11' AS [size], 'PLASTIC' AS [material], 'Premium Folding Floor Stands' AS [category] UNION ALL 
SELECT 249 AS [productorder], 'P-0489' AS [sku], 'CAUTION WET FLOOR CUIDADA PISO MOJADO - PREMIUM FLOOR STAND' AS [producttitle], '25x11' AS [size], 'PLASTIC' AS [material], 'Premium Folding Floor Stands' AS [category] UNION ALL 
SELECT 250 AS [productorder], 'BA-3001' AS [sku], 'WIDE LOAD / OVERSIZE LOAD DOUBLE-SIDED BANNER' AS [producttitle], '18x96' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 251 AS [productorder], 'SB-419' AS [sku], 'SAFETY FIRST - REINFORCED WHITE VINYL WITH 4 GROMMET TABS' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 252 AS [productorder], 'SB-451' AS [sku], 'BANNER KEEP OUR PLANT CLEAN PICTO PICK-UP CLEAN-UP ELIMINATE' AS [producttitle], '24X60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 253 AS [productorder], 'SB-348' AS [sku], 'WORK SAFELY TODAY' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 254 AS [productorder], 'SB-351' AS [sku], 'YOU ARE THE KEY TO SAFETY' AS [producttitle], '24x60' AS [size], 'BANNER' AS [material], 'Banners' AS [category] UNION ALL 
SELECT 255 AS [productorder], 'R1-1RA16' AS [sku], 'STOP SIGN - REGULATORY TRAFFIC SIGN' AS [producttitle], '24x24' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 256 AS [productorder], 'R1-1RA22' AS [sku], 'STOP SIGN - REGULATORY TRAFFIC SIGN' AS [producttitle], '30x30' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 257 AS [productorder], 'R1-2RA22' AS [sku], 'YIELD - REGULATORY TRAFFIC SIGNS' AS [producttitle], '30x30' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 258 AS [productorder], 'R5-1RA16' AS [sku], 'DO NOT ENTER - REGULATORY TRAFFIC SIGNS' AS [producttitle], '24x24' AS [size], 'EGP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 259 AS [productorder], 'R5-1HIA22' AS [sku], 'DO NOT ENTER - REGULATORY TRAFFIC SIGNS' AS [producttitle], '30x30' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 260 AS [productorder], 'R2-1HIA9' AS [sku], 'SPEED LIMIT SIGN' AS [producttitle], '24x18' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 261 AS [productorder], 'W11-2ADG16' AS [sku], 'PEDESTRIAN CROSSING SYMBOL - WARNING TRAFFIC SIGN' AS [producttitle], '24x24' AS [size], 'HIP ALUMINUM' AS [material], 'Traffic Signs' AS [category] UNION ALL 
SELECT 262 AS [productorder], 'R-70AL5' AS [sku], 'NO PARKING SIGN- RED ON WHITE WITH BORDER - PARKING CONTROL SIGNS' AS [producttitle], '18x12' AS [size], 'ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 263 AS [productorder], 'R-70RA5' AS [sku], 'NO PARKING SIGN- RED ON WHITE WITH BORDER - PARKING CONTROL SIGNS' AS [producttitle], '18x12' AS [size], 'EGP ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 264 AS [productorder], 'R7-8NRA5' AS [sku], 'RESERVED PARKING PICTO - HANDICAPPED PARKING SIGN' AS [producttitle], '18x12' AS [size], 'EGP ALUMINUM' AS [material], 'Parking Signs' AS [category] UNION ALL 
SELECT 265 AS [productorder], 'W-65HIA32' AS [sku], 'ROAD WORK AHEAD - CONSTRUCTION TRAFFIC SIGN' AS [producttitle], '48x48' AS [size], 'HIP ALUMINUM' AS [material], 'Road Construction Signs' AS [category] UNION ALL 
SELECT 266 AS [productorder], 'W3-4HIA27' AS [sku], 'BE PREPARED TO STOP - CONSTRUCTION TRAFFIC SIGN' AS [producttitle], '36x36' AS [size], 'HIP ALUMINUM' AS [material], 'Road Construction Signs' AS [category] UNION ALL 
SELECT 267 AS [productorder], 'SMV-1' AS [sku], 'SLOW MOVING VEHICLE SIGN' AS [producttitle], '14x16' AS [size], 'ALUMINUM' AS [material], 'Slow Moving Vehicle Emblems' AS [category] UNION ALL 
SELECT 268 AS [productorder], 'SMV-2' AS [sku], 'SLOW MOVING VEHICLE SIGN' AS [producttitle], '14x16' AS [size], 'REFLECTIVE ALUMINUM' AS [material], 'Slow Moving Vehicle Emblems' AS [category] UNION ALL 
SELECT 269 AS [productorder], 'PL-17R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '18x18' AS [size], 'EGP 12" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 270 AS [productorder], 'PL-18R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '18x18' AS [size], 'EGP 72" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 271 AS [productorder], 'PL-25R' AS [sku], 'STOP SLOW PADDLE SIGN' AS [producttitle], '24x24' AS [size], 'EGP 81" HANDLE' AS [material], 'Stop | Slow Paddle Signs' AS [category] UNION ALL 
SELECT 272 AS [productorder], 'MS-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 273 AS [productorder], 'MSV-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 274 AS [productorder], 'MSR-1' AS [sku], 'BE PREPARED TO STOP ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 275 AS [productorder], 'MS-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 276 AS [productorder], 'MSV-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 277 AS [productorder], 'MSR-10' AS [sku], 'ROAD WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 278 AS [productorder], 'MS-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'MESH' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 279 AS [productorder], 'MSV-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'FLUORESCENT' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 280 AS [productorder], 'MSR-24' AS [sku], 'UTILITY WORK AHEAD ROLL UP SIGN' AS [producttitle], '48x48' AS [size], 'REFLECTIVE' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 281 AS [productorder], 'DL-1000W' AS [sku], 'TRAFFIC SIGN STAND - ROLL UP' AS [producttitle], '36x36' AS [size], 'ALUMINUM | STEEL' AS [material], 'Roll-up Signs and Stands' AS [category] UNION ALL 
SELECT 282 AS [productorder], 'P-8' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '8’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 283 AS [productorder], 'P-10' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '10’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 284 AS [productorder], 'P-12' AS [sku], 'HEAVY GAUGE GREEN U-CHANNEL POST' AS [producttitle], '12’' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 285 AS [productorder], 'GP-8' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '8’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 286 AS [productorder], 'GP-10' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '10’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 287 AS [productorder], 'GP-12' AS [sku], 'HEAVY GAUGE GALVANIZED U-CHANNEL POST' AS [producttitle], '12’' AS [size], 'GALVANIZED' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 288 AS [productorder], 'ST-5' AS [sku], 'PORTABLE SIGN BASE AND POST' AS [producttitle], '48x18' AS [size], 'STEEL' AS [material], 'Sign Posts' AS [category] UNION ALL 
SELECT 289 AS [productorder], 'CONE-18' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '18”' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 290 AS [productorder], 'CONE-28' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '28”' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 291 AS [productorder], 'CONE-36' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '36"' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 292 AS [productorder], 'REFCONE-18' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '18”' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 293 AS [productorder], 'REFCONE-28' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '28”' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 294 AS [productorder], 'REFCONE-36' AS [sku], 'ULTRA BRITE TRAFFIC CONES' AS [producttitle], '36"' AS [size], 'RUBBER' AS [material], 'Traffic Cones' AS [category] UNION ALL 
SELECT 295 AS [productorder], 'DOT-05494' AS [sku], 'EXPLOSIVES 1.1 - CLASS 1 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 296 AS [productorder], 'DOT-05499' AS [sku], 'EXPLOSIVES 1.1 - CLASS 1 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 297 AS [productorder], 'DOT-26224' AS [sku], 'NON-FLAMMABLE GAS PICTO BLANK - CLASS 2 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 298 AS [productorder], 'DOT-26229' AS [sku], 'NON-FLAMMABLE GAS PICTO BLANK - CLASS 2 DOT PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 299 AS [productorder], 'DOT-20804' AS [sku], 'DOT (FLAME PICTO) FLAMMABLE 3' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 300 AS [productorder], 'DOT-26809' AS [sku], 'DOT (FLAME PICTO) FLAMMABLE 3' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 301 AS [productorder], 'DOT-20874' AS [sku], 'SPONTANEOUSLY COMBUSTIBLE FIRE PICTO - CLASS 4 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 302 AS [productorder], 'DOT-20879' AS [sku], 'SPONTANEOUSLY COMBUSTIBLE FIRE PICTO - CLASS 4 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 303 AS [productorder], 'DOT-57244' AS [sku], 'OXIDIZER - CLASS 5 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 304 AS [productorder], 'DOT-57249' AS [sku], 'OXIDIZER - CLASS 5 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 305 AS [productorder], 'DOT-18444' AS [sku], 'POISON PICTO DIAMOND BLANK - CLASS 6 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 306 AS [productorder], 'DOT-18449' AS [sku], 'POISON PICTO DIAMOND BLANK - CLASS 6 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 307 AS [productorder], 'DOT-77774' AS [sku], 'RADIOACTIVE WITH RAD SYMBOL - CLASS 7 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 308 AS [productorder], 'DOT-77779' AS [sku], 'RADIOACTIVE WITH RAD SYMBOL - CLASS 7 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 309 AS [productorder], 'DOT-08374' AS [sku], '(PICTO) CORROSIVE CLASS 8' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 310 AS [productorder], 'DOT-08379' AS [sku], '(PICTO) CORROSIVE CLASS 8' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 311 AS [productorder], 'DOT-11084' AS [sku], 'DANGEROUS RED TRIANGLE - CLASS 9 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 312 AS [productorder], 'DOT-11089' AS [sku], 'DANGEROUS RED TRIANGLE - CLASS 9 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 313 AS [productorder], 'DOT-96754' AS [sku], 'DOT (FLAME PICTO) 1993 FLAMMABLE LIQUIDS n.o.s. FUEL OIL DIESEL FUEL CLASS 3 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'ADHESIVE VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 314 AS [productorder], 'DOT-96759' AS [sku], 'DOT (FLAME PICTO) 1993 FLAMMABLE LIQUIDS n.o.s. FUEL OIL DIESEL FUEL CLASS 3 PLACARD' AS [producttitle], '10.75x10.75' AS [size], 'RIGID VINYL' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 315 AS [productorder], 'PLT-02' AS [sku], '4 LEGEND PLACARD SYSTEM WITH METAL FLIP UN NUMBERS' AS [producttitle], '14X14' AS [size], 'ALUMINUM' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 316 AS [productorder], 'PLT-03' AS [sku], '6 LEGEND PLACARD SYSTEM WITH METAL FLIP UN NUMBERS' AS [producttitle], '14X14' AS [size], 'ALUMINUM' AS [material], 'DOT Placards and Holders' AS [category] UNION ALL 
SELECT 317 AS [productorder], 'PLT-01' AS [sku], 'RIVETED ALUMINUM PLACARD HOLDER' AS [producttitle], '12x14' AS [size], 'ALUMINUM' AS [material], 'DOT Placards and Holders' AS [category]
...
SELECT 
    ...
    CASE 
        WHEN producttitle = 'PREMIUM REFLECTIVE STRIPS - HELMET / HARD HAT MARKERS' THEN 'HMRS.jpg'
        WHEN producttitle = 'MASTER LOCK MODEL NO 3 LAMINATED STEEL SAFETY PADLOCK' THEN 'MODEL 3 LOCKS.jpg'
        WHEN producttitle = 'MASTER LOCK MODEL NO. 410 THERMOPLASTIC SAFETY PADLOCK' THEN 'MODEL 410 LOCKS.jpg'
        WHEN producttitle = 'REFLECTIVE SAFETY TAPE - 2 Inch' THEN 'RST1.JPG'
        WHEN producttitle = 'ULTRA BRITE TRAFFIC CONES' THEN 'TRAFFIC CONES.jpg'
        WHEN [sku] = 'DOT-20804' THEN 'dot-2680.jpg'
        ELSE ISNULL((SELECT [Picture Name] FROM [FMP].[Products] AS x1 WHERE [SS_SIGN] = pd.[sku]), '') 
    END AS [picturename],
    ISNULL([size],'') AS [size],
